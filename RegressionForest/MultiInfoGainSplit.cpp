...
//********************************************************************************************************
//FUNCTION:
void CMultiInfoGainSpliter::_generateSortedFeatureResponsePairSetV(const std::vector<int>& vBootstrapIndex, const std::pair<int, int>& vBootstrapRange, unsigned int vFeatureIndex, std::vector<std::pair<float, float>>& voSortedFeatureResponseSet)
{
	...
	// NOTE: voSortedFeatureResponseSet.second 中连续存储m维响应值
}
